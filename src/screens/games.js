  ...
  return (
    <>
      ...
      <div className='flex flex-row gap-4 md:w-[600px] px-4'>
        <div className='rounded-lg h-[200px] md:h-[300px] w-1/2 md:w-[400px] bg-purple-500'></div>
        <div>
      ...
      <div>
        ...
        <div className='flex flex-row gap-4 md:w-[600px] px-4 mb-4'>
          <div className='rounded-lg h-[200px] md:h-60 w-2/3 md:w-[400px] bg-purple-500'></div>
          <div>
        ...
        <div className='flex flex-row gap-4 md:w-[600px] px-4 mb-4'>
          <div className='rounded-lg h-[200px] md:h-h-60 w-2/3 md:w-[400px] bg-purple-500'></div>
          <div>
            <p className='text-sm font-medium'>Featured Game</p>
      ...
      <div>
        ...
        <div className='px-4 w-full flex flex-row gap-2 overflow-auto'>
          <Link to="/#" className='flex flex-col gap-2 mb-4'>
            <div className='rounded-lg h-[150px] md:h-h-60 min-w-[200px] bg-purple-500'></div>
